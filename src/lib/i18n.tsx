...
const dict = {
  id: {
    ...
    "faq.a2": "Ya, semua file bisa didownload gratis. Anda akan melewati halaman iklan singkat (Safelinku) untuk mendukung layanan tetap gratis.",
    ...
    "faq.a5": "File .APK dan .APKS dengan ukuran maksimal 500MB.",
    ...
    "about.feature1": "Upload file APK/APKS hingga 500MB",
  ...
  en: {
    ...
    "faq.a2": "Yes, all files are free to download. You'll pass through a brief ad page (Safelinku) so the service can stay free.",
    ...
    "faq.a5": ".APK and .APKS files up to 500MB.",
    ...
    "about.feature1": "Upload APK/APKS files up to 500MB",
